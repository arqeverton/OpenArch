...
uses
  Classes, SysUtils, Forms, Controls, ComCtrls, Buttons;

type

  { TArchToolBoxFrame }

  TArchToolBoxFrame = class(TFrame)
    CoolBar1: TCoolBar;
    CoolBar2: TCoolBar;
    CoolBar3: TCoolBar;
...
constructor TArchToolBoxFrame.Create(TheOwner: TComponent);
begin
